...
public class UserSearchControllerHexagonal {
    ...
    public UserSearchControllerHexagonal(UserSearchService userSearchService, Mapper<UserDto, User> userMapper, Mapper<CriteriaPrimitive, Criteria> criteriaMapper) {
